...
const mainBody = {
  ...
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/StephSL9",
    },
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/stephenlui9/",
    }
  ],
};
...
const about = {
  ...
  heading: "About Me",
  message:
    "My name is Stephen Lui. My goal is to pursue career success in the field of data analysis. In my free time I like working on open source projects.",
...
const repos = {
  ...
  gitHubUsername: "StephSL9", //i.e."johnDoe12Gh"
  reposLength: 4,
  specificRepos: [],
};
